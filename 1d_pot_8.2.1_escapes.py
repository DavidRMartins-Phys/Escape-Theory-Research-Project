...
gamma_num = 150 #change this depending on how many damping values we want
...
for i in range(gamma_num):
    mat = escape_matrix(runs, ensemble_num, damping[i])
    np.save(f"escape_gamma_{i}_T_{T}.npy", mat)
